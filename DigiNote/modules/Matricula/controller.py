...
class MatriculaController:
    ...
    def get_matricula_by_id(self, id):
        try:
            ...
            asignaciones = [ma.idAsignacion for ma in matricula.matricula_asignacion]
            result = {
    ...
    def update_matricula(self, id, request):
        if request.method == 'POST':
            try:
                ...
                actuales_asignaciones = {str(ma.idAsignacion) for ma in matricula.matricula_asignacion}
